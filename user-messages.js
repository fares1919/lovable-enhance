/**
 * Lovable Enhance - User-facing copy: English translations + strip internal/hosting/vendor branding.
 */
function stripInternalBranding(value) {
  if (value == null) return value;
  var brand = typeof EXTENSION_NAME !== "undefined" ? String(EXTENSION_NAME) : "Lovable Enhance";
  var s = String(value);
